...
import android.view.*
import app.folder.example.dell.Speciality_March_Folder_2021.Main_Fragment_Animated.ProductD_Fragment_Main
import app.folder.example.dell.Speciality_March_Folder_2021.Product_Fragments_Animated.ProductD_Animated_Fragments.*
...
class ProductD_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FT?.replace(R.id.containerView, ProductD_Fragment_Main())?.commit()
        fn_checkLocation()
    }
