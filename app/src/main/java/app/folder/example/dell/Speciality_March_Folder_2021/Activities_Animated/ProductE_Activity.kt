...
import android.view.*
import app.folder.example.dell.Speciality_March_Folder_2021.Main_Fragment_Animated.ProductE_Fragment_Main
...
class ProductE_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FT?.replace(R.id.containerView, ProductE_Fragment_Main())?.commit()
        fn_checkLocation()
    }
