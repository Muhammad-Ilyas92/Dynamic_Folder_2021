package app.folder.example.dell.Speciality_March_Folder_2021.Activities_Static
...
import android.view.*
import app.folder.example.dell.Speciality_March_Folder_2021.Main_Fragment_Static.ProductE_Fragment_Main_Static
import app.folder.example.dell.Speciality_March_Folder_2021.Product_Fragments_Static.ProductE_Static_Fragments.*
...
class ProductE_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FT?.replace(R.id.containerView, ProductE_Fragment_Main_Static())?.commit()
        fn_checkLocation()
    }
