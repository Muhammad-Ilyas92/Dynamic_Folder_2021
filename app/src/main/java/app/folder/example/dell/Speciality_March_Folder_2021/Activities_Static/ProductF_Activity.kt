...
import android.view.*
import app.folder.example.dell.Speciality_March_Folder_2021.Main_Fragment_Static.ProductF_Fragment_Main_Static
...
class ProductF_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FT?.replace(R.id.containerView, ProductF_Fragment_Main_Static())?.commit()
        fn_checkLocation()
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.product_F_Complete -> {
                ...
                fragmentTransaction13.replace(R.id.containerView, ProductF_Fragment_Main_Static())
                    .commit()
                true
            }
