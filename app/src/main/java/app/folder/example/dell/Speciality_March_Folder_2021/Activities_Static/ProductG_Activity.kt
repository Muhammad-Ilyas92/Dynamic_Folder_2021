...
import android.view.*
import app.folder.example.dell.Speciality_March_Folder_2021.Main_Fragment_Static.ProductG_Fragment_Main_Static
import app.folder.example.dell.Speciality_March_Folder_2021.Product_Fragments_Static.ProductG_Static_Fragments.*
...
class ProductG_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FT?.replace(R.id.containerView, ProductG_Fragment_Main_Static())?.commit()
        fn_checkLocation()
    }
