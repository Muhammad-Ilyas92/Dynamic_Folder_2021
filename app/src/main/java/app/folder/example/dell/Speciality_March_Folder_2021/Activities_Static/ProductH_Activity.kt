...
import android.view.*
import app.folder.example.dell.Speciality_March_Folder_2021.Main_Fragment_Static.ProductH_Fragment_Main_Static
import app.folder.example.dell.Speciality_March_Folder_2021.Product_Fragments_Static.ProductH_Static_Fragments.*
...
class ProductH_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FT?.replace(R.id.containerView, ProductH_Fragment_Main_Static())?.commit()
        fn_checkLocation()
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.product_H_Complete -> {
                ...
                fragmentTransaction10.replace(R.id.containerView, ProductH_Fragment_Main_Static())
                    .commit()
                true
            }
