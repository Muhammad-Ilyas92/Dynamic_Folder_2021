...
import android.view.*
import app.folder.example.dell.Speciality_March_Folder_2021.Main_Fragment_Static.ProductI_Fragment_Main_Static
...
class ProductI_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FT?.replace(R.id.containerView0, ProductI_Fragment_Main_Static())?.commit()
        fn_checkLocation()
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.product_I_Complete -> {
                ...
                fragmentTransaction9.replace(R.id.containerView0, ProductI_Fragment_Main_Static())
                    .commit()
                true
            }
