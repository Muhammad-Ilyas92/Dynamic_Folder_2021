...
class ProductD_Adapter(fm: FragmentManager?) : FragmentStatePagerAdapter(fm) {
    override fun getItem(position: Int): Fragment? {
        when (position) {
            ...
            6 -> return ProductD_Fragment_page_Twelve()
            7 -> return ProductD_Fragment_page_Seven()
            8 -> return ProductD_Fragment_page_Eight()
            9 -> return ProductD_Fragment_page_Nine()
            10 -> return ProductD_Fragment_page_Ten()
            11 -> return ProductD_Fragment_page_Eleven()
        }
        return null
    }
