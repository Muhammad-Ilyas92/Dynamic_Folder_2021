...
import app.folder.example.dell.Speciality_March_Folder_2021.Product_Fragments_Animated.ProductF_Animated_Fragments.*
...
class ProductF_Adapter(fm: FragmentManager?) : FragmentStatePagerAdapter(fm) {
    override fun getItem(position: Int): Fragment? {
        when (position) {
            ...
            9 -> return ProductF_Fragment_page_Eleven()
            10 -> return ProductF_Fragment_page_Thirteen()
            11 -> return ProductF_Fragment_page_Ten()
            12 -> return ProductF_Fragment_page_Twelve()
            13 -> return ProductF_Fragment_page_Fourteen()
        }
        return null
    }
