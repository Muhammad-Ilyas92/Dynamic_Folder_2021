package app.folder.example.dell.Speciality_March_Folder_2021.Main_Fragment_Animated
...
import app.folder.example.dell.Speciality_March_Folder_2021.Adapter_Animated.ProductA_Adapter
import app.folder.example.dell.Speciality_March_Folder_2021.R
import app.folder.example.dell.Speciality_March_Folder_2021.Transformations.FadeOutTransformation
import app.folder.example.dell.Speciality_March_Folder_2021.Transformations.SimpleTransformation

/**
 * A simple [Fragment] subclass.
 */
class ProductA_Fragment_Main : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.product_a_fragment_main, container, false)
        viewPager_complete = view.findViewById<View>(R.id.viewpager_complete) as ViewPager
        // pagerTabStrip = (PagerTabStrip)view.findViewById(R.id.pagertabstrip_id);
        viewPager_complete!!.adapter = ProductA_Adapter(
            childFragmentManager
        )
        //viewPager_complete.setPageTransformer(true, new ZoomInTransformer());
        viewPager_complete!!.setPageTransformer(true, FadeOutTransformation())
