...
import app.folder.example.dell.Speciality_March_Folder_2021.Adapter_Animated.ProductD_Adapter
 ...
 */
class ProductD_Fragment_Main : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.product_d_fragment_main, container, false)
        viewPager_complete = view.findViewById<View>(R.id.viewpager_complete_productD) as ViewPager
        // pagerTabStrip = (PagerTabStrip)view.findViewById(R.id.pagertabstrip_id_productC);
        viewPager_complete!!.adapter = ProductD_Adapter(
