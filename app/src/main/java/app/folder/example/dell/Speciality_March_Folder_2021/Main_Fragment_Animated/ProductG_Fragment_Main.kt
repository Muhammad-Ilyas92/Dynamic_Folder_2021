...
import app.folder.example.dell.Speciality_March_Folder_2021.Adapter_Animated.ProductG_Adapter
 ...
 */
class ProductG_Fragment_Main : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.product_g_fragment_main, container, false)
        viewPager_complete = view.findViewById<View>(R.id.viewpager_complete_productG) as ViewPager
        // pagerTabStrip = (PagerTabStrip)view.findViewById(R.id.pagertabstrip_id_productC);
        viewPager_complete!!.adapter = ProductG_Adapter(
