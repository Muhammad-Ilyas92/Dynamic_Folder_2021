...
import app.folder.example.dell.Speciality_March_Folder_2021.Adapter_Animated.ProductL_Adapter
...
class ProductL_Fragment_Main : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.product_l_fragment_main, container, false)
        ...
        viewPager_complete!!.adapter = ProductL_Adapter(
