...
import app.folder.example.dell.Speciality_March_Folder_2021.Adapter_Animated.ProductL_Adapter_A
...
class ProductL_Fragment_Main_A : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.product_l_fragment_main_a, container, false)
        viewPager_complete = view.findViewById<View>(R.id.viewpager_complete_productL) as ViewPager
        // pagerTabStrip = (PagerTabStrip)view.findViewById(R.id.pagertabstrip_id);
        viewPager_complete!!.adapter = ProductL_Adapter_A(
