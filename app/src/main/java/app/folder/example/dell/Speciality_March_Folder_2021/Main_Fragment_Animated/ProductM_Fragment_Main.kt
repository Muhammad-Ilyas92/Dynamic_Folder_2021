...
import app.folder.example.dell.Speciality_March_Folder_2021.Adapter_Animated.ProductM_Adapter
...
class ProductM_Fragment_Main : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.product_m_fragment_main, container, false)
        viewPager_complete = view.findViewById<View>(R.id.viewpager_complete_productM) as ViewPager
        // pagerTabStrip = (PagerTabStrip)view.findViewById(R.id.pagertabstrip_id);
        viewPager_complete!!.adapter = ProductM_Adapter(
