...
class ProductA_Fragment_page_Six : Fragment() {
    ...
    override fun onCreateView(
        ...
        image_background = view.findViewById<View>(R.id.qbal_page6_background) as ImageView
        image_header1 = view.findViewById<View>(R.id.qbal_page6_header1) as ImageView
        image_header2 = view.findViewById<View>(R.id.qbal_page6_header2) as ImageView
        image1 = view.findViewById<View>(R.id.qbal_page6_image1) as ImageView
        image2 = view.findViewById<View>(R.id.qbal_page6_image2) as ImageView
        image3 = view.findViewById<View>(R.id.qbal_page6_image3) as ImageView
        image4 = view.findViewById<View>(R.id.qbal_page6_image4) as ImageView
        ...
        switch (density) {
            case DisplayMetrics.DENSITY_LOW:
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality_April_2021/tanzo/drawable-ldpi/tanzo_page6_background.png").into(image_background);
                ...
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality_April_2021/tanzo/drawable-ldpi/tanzo_page6_image1.png").into(image1);
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality_April_2021/tanzo/drawable-ldpi/tanzo_page6_image2.png").into(image2);
