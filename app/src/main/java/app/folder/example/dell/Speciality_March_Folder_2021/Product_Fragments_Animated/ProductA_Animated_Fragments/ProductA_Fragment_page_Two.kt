...
//String videopath = "android.resource://app.folder.example.dell.indigo_folders/" + R.raw.omeprazole;
    ...
    override fun onCreateView(
        ...
        image_background = view.findViewById<View>(R.id.qbal_page2_background) as ImageView
        image_header1 = view.findViewById<View>(R.id.qbal_page2_header1) as ImageView
        image_header2 = view.findViewById<View>(R.id.qbal_page2_header2) as ImageView
        image1 = view.findViewById<View>(R.id.qbal_page2_image1) as ImageView
        image2 = view.findViewById<View>(R.id.qbal_page2_image2) as ImageView
        image3 = view.findViewById<View>(R.id.qbal_page2_image3) as ImageView
        image4 = view.findViewById<View>(R.id.qbal_page2_image4) as ImageView
