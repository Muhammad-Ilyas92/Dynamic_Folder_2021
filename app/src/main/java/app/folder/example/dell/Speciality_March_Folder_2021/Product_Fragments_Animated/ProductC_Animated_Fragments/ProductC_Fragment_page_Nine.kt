...
class ProductC_Fragment_page_Nine : Fragment() {
    ...
    override fun onCreateView(
        ...
        val animation_image6 = AnimationUtils.loadAnimation(context, R.anim.slide_down_three_sec)
        //  Animation animation_image7 = AnimationUtils.loadAnimation(getContext(), R.anim.move_from_right_one_n_half_second);
