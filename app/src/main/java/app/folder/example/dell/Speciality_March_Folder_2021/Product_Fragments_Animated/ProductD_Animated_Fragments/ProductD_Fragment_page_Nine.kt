...
class ProductD_Fragment_page_Nine : Fragment() {
    ...
    override fun onCreateView(
        ...
        image_background = view.findViewById<View>(R.id.cilapen_page9_background) as ImageView
        image1 = view.findViewById<View>(R.id.cilapen_page9_image1) as ImageView
        image2 = view.findViewById<View>(R.id.cilapen_page9_image2) as ImageView
        image3 = view.findViewById<View>(R.id.cilapen_page9_image3) as ImageView
        //   image4 = (ImageView) view.findViewById(R.id.cilapen_page9_image4);
        //   image5 = (ImageView) view.findViewById(R.id.cilapen_page9_image5);
...
/*
        ...
        switch (density) {
            case DisplayMetrics.DENSITY_LOW:
                ...
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-ldpi/cilapen_page9_image1.png").into(image1);
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-ldpi/cilapen_page9_image2.png").into(image2);
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-ldpi/cilapen_page9_image3.png").into(image3);
         //       Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-ldpi/cilapen_page9_image4.png").into(image4);
        ...
        //         Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-ldpi/cilapen_page7_image9.png").into(image9);
            ...
            case DisplayMetrics.DENSITY_MEDIUM:
                ...
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-mdpi/cilapen_page9_image1.png").into(image1);
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-mdpi/cilapen_page9_image2.png").into(image2);
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-mdpi/cilapen_page9_image3.png").into(image3);
           //     Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-mdpi/cilapen_page9_image4.png").into(image4);
         ...
         //       Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-mdpi/cilapen_page7_image8.png").into(image8);
          //       Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-mdpi/cilapen_page7_image9.png").into(image9);
            ...
            case DisplayMetrics.DENSITY_HIGH:
                ...
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-hdpi/cilapen_page9_image1.png").into(image1);
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-hdpi/cilapen_page9_image2.png").into(image2);
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-hdpi/cilapen_page9_image3.png").into(image3);
         //       Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-hdpi/cilapen_page9_image4.png").into(image4);
       ...
       //         Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-hdpi/cilapen_page7_image8.png").into(image8);
        //         Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-hdpi/cilapen_page7_image9.png").into(image9);
            ...
            case DisplayMetrics.DENSITY_XHIGH:
                ...
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-xhdpi/cilapen_page9_image1.png").into(image1);
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-xhdpi/cilapen_page9_image2.png").into(image2);
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-xhdpi/cilapen_page9_image3.png").into(image3);
        //        Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-xhdpi/cilapen_page9_image4.png").into(image4);
      ...
      //           Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-xhdpi/cilapen_page7_image9.png").into(image9);
          ...
          Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-xxhdpi/cilapen_page7_background.png").into(image_background);
                ...
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-xxhdpi/cilapen_page9_image1.png").into(image1);
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-xxhdpi/cilapen_page9_image2.png").into(image2);
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-xxhdpi/cilapen_page9_image3.png").into(image3);
       //         Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-xxhdpi/cilapen_page9_image4.png").into(image4);
      ...
      //          Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-xxhdpi/cilapen_page7_image9.png").into(image9);
            ...
            case DisplayMetrics.DENSITY_XXXHIGH:
             ...
             Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-xxxhdpi/cilapen_page7_background.png").into(image_background);
                ...
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-xxxhdpi/cilapen_page9_image1.png").into(image1);
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-xxxhdpi/cilapen_page9_image2.png").into(image2);
                Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-xxxhdpi/cilapen_page9_image3.png").into(image3);
        //       Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/Speciality2020_December/cilapen/drawable-xxxhdpi/cilapen_page9_image4.png").into(image4);
