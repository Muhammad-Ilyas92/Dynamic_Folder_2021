 ...
 */
class ProductE_Fragment_page_Eight : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.product_e_fragment_page_8, container, false)
      /*  image_background = view.findViewById<View>(R.id.cebac_page8_background) as ImageView
        image_header1 = view.findViewById<View>(R.id.cebac_page8_header1) as ImageView
        image_header2 = view.findViewById<View>(R.id.cebac_page8_header2) as ImageView
        image1 = view.findViewById<View>(R.id.cebac_page8_image1) as ImageView
        image2 = view.findViewById<View>(R.id.cebac_page8_image2) as ImageView
        image3 = view.findViewById<View>(R.id.cebac_page8_image3) as ImageView
        image4 = view.findViewById<View>(R.id.cebac_page8_image4) as ImageView
        image5 = view.findViewById<View>(R.id.cebac_page8_image5) as ImageView
        image6 = view.findViewById<View>(R.id.cebac_page8_image6) as ImageView
*/
/*
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    if (touch == 1) {
                        ...
                        Animation animation_image5 = AnimationUtils.loadAnimation(getContext(), R.anim.slide_down);
                        image5.setVisibility(View.VISIBLE);
                        image5.startAnimation(animation_image5);
                    } else if (touch == 4) {
                        Animation animation_image6 = AnimationUtils.loadAnimation(getContext(), R.anim.slide_down);
                        ...
                        Animation animation_image10 = AnimationUtils.loadAnimation(getContext(), R.anim.zoom_in_one_sec);
                        image10.setVisibility(View.VISIBLE);
                        image10.startAnimation(animation_image10);
                    } else if (touch == 8) {
                        Animation animation_image11 = AnimationUtils.loadAnimation(getContext(), R.anim.zoom_in_one_sec);
                        image11.setVisibility(View.VISIBLE);
                        image11.startAnimation(animation_image11);
                    } else if (touch == 9) {
                        Animation animation_image12 = AnimationUtils.loadAnimation(getContext(), R.anim.zoom_in_one_sec);
