...
class ProductE_Fragment_page_Three : Fragment() {
    ...
    override fun onCreateView(
      ...
      /*  image_background = view.findViewById<View>(R.id.cebac_page3_background) as ImageView
        image_header1 = view.findViewById<View>(R.id.cebac_page3_header1) as ImageView
        image_header2 = view.findViewById<View>(R.id.cebac_page3_header2) as ImageView
        image1 = view.findViewById<View>(R.id.cebac_page3_image1) as ImageView
        image2 = view.findViewById<View>(R.id.cebac_page3_image2) as ImageView
        image3 = view.findViewById<View>(R.id.cebac_page3_image3) as ImageView
        image4 = view.findViewById<View>(R.id.cebac_page3_image4) as ImageView*/
