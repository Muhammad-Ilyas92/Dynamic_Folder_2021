...
class ProductF_Fragment_page_Ten : Fragment() {
    ...
    override fun onCreateView(
     ...
     /*   image_background = view.findViewById<View>(R.id.ticozid_page10_background) as ImageView
        image1 = view.findViewById<View>(R.id.ticozid_page10_image1) as ImageView
        image2 = view.findViewById<View>(R.id.ticozid_page10_image2) as ImageView
        image3 = view.findViewById<View>(R.id.ticozid_page10_image3) as ImageView
        image4 = view.findViewById<View>(R.id.ticozid_page10_image4) as ImageView
        image5 = view.findViewById<View>(R.id.ticozid_page10_image5) as ImageView*/
