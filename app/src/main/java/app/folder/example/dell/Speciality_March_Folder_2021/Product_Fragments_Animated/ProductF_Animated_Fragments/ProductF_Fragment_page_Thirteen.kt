...
class ProductF_Fragment_page_Thirteen : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.product_f_fragment_page_13, container, false)
      /*  image_background = view.findViewById<View>(R.id.ticozid_page13_background) as ImageView
        image1 = view.findViewById<View>(R.id.ticozid_page13_image1) as ImageView
        image2 = view.findViewById<View>(R.id.ticozid_page13_image2) as ImageView
        image3 = view.findViewById<View>(R.id.ticozid_page13_image3) as ImageView*/
