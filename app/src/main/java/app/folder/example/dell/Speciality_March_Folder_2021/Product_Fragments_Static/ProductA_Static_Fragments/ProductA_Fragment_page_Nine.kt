...
class ProductA_Fragment_page_Nine : Fragment() {
    ...
    override fun onCreateView(
        ...
        /*  image_background = (ImageView) view.findViewById(R.id.calamox_a_page9_background);

        image1 = (ImageView) view.findViewById(R.id.calamox_a_page9_image1);
        image2 = (ImageView) view.findViewById(R.id.calamox_a_page9_image2);
        image3 = (ImageView) view.findViewById(R.id.calamox_a_page9_image3);
        image4 = (ImageView) view.findViewById(R.id.calamox_a_page9_image4);
        image5 = (ImageView) view.findViewById(R.id.calamox_a_page9_image5);*/
