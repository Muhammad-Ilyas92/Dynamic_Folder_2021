...
/*
        ...
        image_background = (ImageView) view.findViewById(R.id.bofalgan_page10_background);

        header_image = (ImageView) view.findViewById(R.id.bofalgan_page10_header);
        header_image1 = (ImageView) view.findViewById(R.id.bofalgan_page10_header1);
        header_image2 = (ImageView) view.findViewById(R.id.bofalgan_page10_header2);
        header_image3 = (ImageView) view.findViewById(R.id.bofalgan_page10_header3);
        header_image4 = (ImageView) view.findViewById(R.id.bofalgan_page10_header4);
        header_image5 = (ImageView) view.findViewById(R.id.bofalgan_page10_header5);
        header_image6 = (ImageView) view.findViewById(R.id.bofalgan_page10_header6);
        header_image7 = (ImageView) view.findViewById(R.id.bofalgan_page10_header7);
        header_image8 = (ImageView) view.findViewById(R.id.bofalgan_page10_header8);

        image1 = (ImageView) view.findViewById(R.id.bofalgan_page10_image1);
        image2 = (ImageView) view.findViewById(R.id.bofalgan_page10_image2);
        image3 = (ImageView) view.findViewById(R.id.bofalgan_page10_image3);
        image4 = (ImageView) view.findViewById(R.id.bofalgan_page10_image4);
        image5 = (ImageView) view.findViewById(R.id.bofalgan_page10_image5);
        image6 = (ImageView) view.findViewById(R.id.bofalgan_page10_image6);
        image7 = (ImageView) view.findViewById(R.id.bofalgan_page10_image7);
        image8 = (ImageView) view.findViewById(R.id.bofalgan_page10_image8);*/
