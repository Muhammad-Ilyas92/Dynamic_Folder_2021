...
/*
        ...
        image_background = (ImageView)view.findViewById(R.id.bofalgan_page3_background);

        header_image = (ImageView)view.findViewById(R.id.bofalgan_page3_header);
        header_image1 = (ImageView)view.findViewById(R.id.bofalgan_page3_header1);
        header_image2 = (ImageView)view.findViewById(R.id.bofalgan_page3_header2);
        header_image3 = (ImageView)view.findViewById(R.id.bofalgan_page3_header3);
        header_image4 = (ImageView)view.findViewById(R.id.bofalgan_page3_header4);
        header_image5 = (ImageView)view.findViewById(R.id.bofalgan_page3_header5);
        header_image6 = (ImageView)view.findViewById(R.id.bofalgan_page3_header6);
        header_image7 = (ImageView)view.findViewById(R.id.bofalgan_page3_header7);
        header_image8 = (ImageView)view.findViewById(R.id.bofalgan_page3_header8);

        image1 = (ImageView)view.findViewById(R.id.bofalgan_page3_image1);
        image2 = (ImageView)view.findViewById(R.id.bofalgan_page3_image2);
        image3 = (ImageView)view.findViewById(R.id.bofalgan_page3_image3);
        ...
        when (density) {
            DisplayMetrics.DENSITY_LOW -> {
                ...
                Picasso.get()
                    ...
                    .into(header_image8)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-ldpi/bofalgan_page3_image1.png")
                    .into(image1)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-ldpi/bofalgan_page3_image2.png")
                    .into(image2)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-ldpi/bofalgan_page3_image3.png")
                    .into(image3)
            }
            DisplayMetrics.DENSITY_MEDIUM -> {
                ...
                Picasso.get()
                    ...
                    .into(header_image8)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-mdpi/bofalgan_page3_image1.png")
                    .into(image1)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-mdpi/bofalgan_page3_image2.png")
                    .into(image2)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-mdpi/bofalgan_page3_image3.png")
                    .into(image3)
            }
            DisplayMetrics.DENSITY_HIGH -> {
                ...
                Picasso.get()
                    ...
                    .into(header_image8)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-hdpi/bofalgan_page3_image1.png")
                    .into(image1)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-hdpi/bofalgan_page3_image2.png")
                    .into(image2)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-hdpi/bofalgan_page3_image3.png")
                    .into(image3)
            }
            DisplayMetrics.DENSITY_XHIGH -> {
                ...
                Picasso.get()
                    ...
                    .into(header_image8)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-xhdpi/bofalgan_page3_image1.png")
                    .into(image1)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-xhdpi/bofalgan_page3_image2.png")
                    .into(image2)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-xhdpi/bofalgan_page3_image3.png")
                    .into(image3)
            }
            DisplayMetrics.DENSITY_XXHIGH -> {
                ...
                Picasso.get()
                    ...
                    .into(header_image8)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-xxhdpi/bofalgan_page3_image1.png")
                    .into(image1)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-xxhdpi/bofalgan_page3_image2.png")
                    .into(image2)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-xxhdpi/bofalgan_page3_image3.png")
                    .into(image3)
            }
            DisplayMetrics.DENSITY_XXXHIGH -> {
                ...
                Picasso.get()
                    ...
                    .into(header_image8)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-xxxhdpi/bofalgan_page3_image1.png")
                    .into(image1)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-xxxhdpi/bofalgan_page3_image2.png")
                    .into(image2)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/bofalgan/drawable-xxxhdpi/bofalgan_page3_image3.png")
                    .into(image3)
            }
        }
        return view
