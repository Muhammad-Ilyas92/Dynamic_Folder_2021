...
/*
        image0 = (ImageView)view.findViewById(R.id.zezot_id_page8_image0);
        image1 = (ImageView)view.findViewById(R.id.zezot_id_page8_image1);
        image2 = (ImageView)view.findViewById(R.id.zezot_id_page8_image2);*/
        // image4 = (ImageView)view.findViewById(R.id.zezot_id_page5_image4);
        ...
        Picasso.get()
            ...
            .into(image0)
        Picasso.get()
            .load("http://work.boschpharmaceutical.com/working/images/penicillin/aggressive/zezot_page8_image1.png")
            .into(image1)
        Picasso.get()
            .load("http://work.boschpharmaceutical.com/working/images/penicillin/aggressive/zezot_page8_image2.png")
            .into(image2)
        // Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/aggressive/zezot_page8_image3.png").into(image4);
        // Picasso.get().load("http://work.boschpharmaceutical.com/working/images/penicillin/aggressive/zezot_page8_image4.png").into(image5);
        ...
        val animation_image1 = AnimationUtils.loadAnimation(context, R.anim.fade_in_two_sec)
