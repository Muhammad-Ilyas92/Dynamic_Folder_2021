...
// String videopath = "android.resource://app.folder.example.dell.Aggressive_Folder_Third_2020/" + R.raw.qlena_title_video_november_2020;
    : Fragment() {
    ...
    override fun onCreateView(
        ...
        /*
        constraintLayout = (ConstraintLayout) view.findViewById(R.id.qlena_page1);
        // Aniation animation_image1 = AnimationUtils.loadAnimation(getContext(), R.anim.one_sec_transition);
        videoView = (VideoView) view.findViewById(R.id.qlena_video);
