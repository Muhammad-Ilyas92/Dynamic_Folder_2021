 ...
 */
class ProductI_Fragment_page_Four : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.product_i_fragment_page_4, container, false)


        /*    image_background = (ImageView) view.findViewById(R.id.flazol_page4_background);
        image_header = (ImageView) view.findViewById(R.id.flazol_page4_header);
        image_header1 = (ImageView) view.findViewById(R.id.flazol_page4_header1);
        image_header2 = (ImageView) view.findViewById(R.id.flazol_page4_header2);
        image_header3 = (ImageView) view.findViewById(R.id.flazol_page4_header3);
        image_header4 = (ImageView) view.findViewById(R.id.flazol_page4_header4);
        image_header5 = (ImageView) view.findViewById(R.id.flazol_page4_header5);
        image_header6 = (ImageView) view.findViewById(R.id.flazol_page4_header6);

        image1 = (ImageView) view.findViewById(R.id.flazol_page4_image1);
        image2 = (ImageView) view.findViewById(R.id.flazol_page4_image2);
        image3 = (ImageView) view.findViewById(R.id.flazol_page4_image3);
        image4 = (ImageView) view.findViewById(R.id.flazol_page4_image4);
        image5 = (ImageView) view.findViewById(R.id.flazol_page4_image5);
        image6 = (ImageView) view.findViewById(R.id.flazol_page4_image6);*/
        ...
        when (density) {
            DisplayMetrics.DENSITY_LOW -> {
                ...
                Picasso.get()
                    ...
                    .into(image_header6)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-ldpi/flazol_page4_image1.png")
                    .into(image1)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-ldpi/flazol_page4_image2.png")
                    .into(image2)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-ldpi/flazol_page4_image3.png")
                    .into(image3)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-ldpi/flazol_page4_image4.png")
                    .into(image4)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-ldpi/flazol_page4_image5.png")
                    .into(image5)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-ldpi/flazol_page4_image6.png")
                    .into(image6)
            }
            DisplayMetrics.DENSITY_MEDIUM -> {
                ...
                Picasso.get()
                    ...
                    .into(image_header6)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-mdpi/flazol_page4_image1.png")
                    .into(image1)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-mdpi/flazol_page4_image2.png")
                    .into(image2)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-mdpi/flazol_page4_image3.png")
                    .into(image3)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-mdpi/flazol_page4_image4.png")
                    .into(image4)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-mdpi/flazol_page4_image5.png")
                    .into(image5)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-mdpi/flazol_page4_image6.png")
                    .into(image6)
            }
            DisplayMetrics.DENSITY_HIGH -> {
                ...
                Picasso.get()
                    ...
                    .into(image_header6)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-hdpi/flazol_page4_image1.png")
                    .into(image1)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-hdpi/flazol_page4_image2.png")
                    .into(image2)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-hdpi/flazol_page4_image3.png")
                    .into(image3)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-hdpi/flazol_page4_image4.png")
                    .into(image4)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-hdpi/flazol_page4_image5.png")
                    .into(image5)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-hdpi/flazol_page4_image6.png")
                    .into(image6)
            }
            DisplayMetrics.DENSITY_XHIGH -> {
                ...
                Picasso.get()
                    ...
                    .into(image_header6)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xhdpi/flazol_page4_image1.png")
                    .into(image1)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xhdpi/flazol_page4_image2.png")
                    .into(image2)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xhdpi/flazol_page4_image3.png")
                    .into(image3)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xhdpi/flazol_page4_image4.png")
                    .into(image4)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xhdpi/flazol_page4_image5.png")
                    .into(image5)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xhdpi/flazol_page4_image6.png")
                    .into(image6)
            }
            DisplayMetrics.DENSITY_XXHIGH -> {
                ...
                Picasso.get()
                    ...
                    .into(image_header6)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xxhdpi/flazol_page4_image1.png")
                    .into(image1)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xxhdpi/flazol_page4_image2.png")
                    .into(image2)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xxhdpi/flazol_page4_image3.png")
                    .into(image3)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xxhdpi/flazol_page4_image4.png")
                    .into(image4)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xxhdpi/flazol_page4_image5.png")
                    .into(image5)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xxhdpi/flazol_page4_image6.png")
                    .into(image6)
            }
            DisplayMetrics.DENSITY_XXXHIGH -> {
                ...
                Picasso.get()
                    ...
                    .into(image_header6)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xxxhdpi/flazol_page4_image1.png")
                    .into(image1)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xxxhdpi/flazol_page4_image2.png")
                    .into(image2)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xxxhdpi/flazol_page4_image3.png")
                    .into(image3)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xxxhdpi/flazol_page4_image4.png")
                    .into(image4)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xxxhdpi/flazol_page4_image5.png")
                    .into(image5)
                Picasso.get()
                    .load("http://work.boschpharmaceutical.com/working/images/penicillin/Aggressive2020_December/flazol/drawable-xxxhdpi/flazol_page4_image6.png")
                    .into(image6)
            }
        }
        return view
