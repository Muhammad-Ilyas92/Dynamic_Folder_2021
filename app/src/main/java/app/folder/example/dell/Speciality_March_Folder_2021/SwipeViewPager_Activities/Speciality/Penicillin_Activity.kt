...
import app.folder.example.dell.Speciality_March_Folder_2021.SwipeViewPager_Adapter.Speciality.Adapter_Penicillin
import java.util.*

class Penicillin_Activity : AppCompatActivity() {
    var viewPager: ViewPager? = null
    var adapterPenicillin: Adapter_Penicillin? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*toolbar close*/setContentView(R.layout.activity_penicillin)
...
*/models = ArrayList()
        ...
        adapterPenicillin = Adapter_Penicillin(models as ArrayList<Model>, this)
        viewPager = findViewById(R.id.viewPager)
        viewPager?.setAdapter(adapterPenicillin)
        ...
        viewPager?.setOnPageChangeListener(object : OnPageChangeListener {
            override fun onPageScrolled(
                ...
                if (position < adapterPenicillin!!.count - 1 && position < colors!!.size - 1) {
    ...
    public void onClick(View view) {
        if (R.id.card_animated != R.id.card_static) {
            Intent intent = new Intent(Penicillin_Activity.this, Animated_Activity.class);
            startActivity(intent);
            Toast.makeText(this, "Animated Folder", Toast.LENGTH_LONG).show();
        }
        else
        {
            Intent intent = new Intent(Penicillin_Activity.this, Static_Page_Activity.class);
            startActivity(intent);
