...
import app.folder.example.dell.Speciality_March_Folder_2021.SwipeViewPager_Adapter.Speciality.Adapter_Spc_A2
import java.util.*

class Spc_A2_Activity : AppCompatActivity() {
    var viewPager: ViewPager? = null
    var adapter_spec_a2: Adapter_Spc_A2? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*toolbar close*/setContentView(R.layout.activity_spc_a2)
        ...
        adapter_spec_a2 = Adapter_Spc_A2(models as ArrayList<Model>, this)
        viewPager = findViewById(R.id.viewPager)
        viewPager?.setAdapter(adapter_spec_a2)
        ...
        viewPager?.setOnPageChangeListener(object : OnPageChangeListener {
            override fun onPageScrolled(
                ...
                if (position < adapter_spec_a2!!.count - 1 && position < colors!!.size - 1) {
