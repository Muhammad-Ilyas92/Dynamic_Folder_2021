...
import app.folder.example.dell.Speciality_March_Folder_2021.SwipeViewPager_Adapter.Speciality.Adapter_Spc_ABC3
import java.util.*

class Spc_ABC3_Activity : AppCompatActivity() {
    var viewPager: ViewPager? = null
    var adapter_spec_abc3: Adapter_Spc_ABC3? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*toolbar close*/setContentView(R.layout.activity_spc_abc3)
        ...
        adapter_spec_abc3 = Adapter_Spc_ABC3(models as ArrayList<Model>, this)
        viewPager = findViewById(R.id.viewPager)
        viewPager?.setAdapter(adapter_spec_abc3)
        ...
        viewPager?.setOnPageChangeListener(object : OnPageChangeListener {
            override fun onPageScrolled(
                ...
                if (position < adapter_spec_abc3!!.count - 1 && position < colors!!.size - 1) {
