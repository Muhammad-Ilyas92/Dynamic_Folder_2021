...
import app.folder.example.dell.Speciality_March_Folder_2021.SwipeViewPager_Adapter.Speciality.Adapter_Spc_ABC
import java.util.*

class Spc_ABC_Activity : AppCompatActivity() {
    var viewPager: ViewPager? = null
    var adapterAgg_ABC: Adapter_Spc_ABC? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*toolbar close*/setContentView(R.layout.activity_spc_abc)
...
*/models = ArrayList()
        ...
        adapterAgg_ABC = Adapter_Spc_ABC(models as ArrayList<Model>, this)
        viewPager = findViewById(R.id.viewPager)
        viewPager?.setAdapter(adapterAgg_ABC)
        ...
        viewPager?.setOnPageChangeListener(object : OnPageChangeListener {
            override fun onPageScrolled(
                ...
                if (position < adapterAgg_ABC!!.count - 1 && position < colors!!.size - 1) {
    ...
    public void onClick(View view) {
        if (R.id.card_animated != R.id.card_static) {
            Intent intent = new Intent(Agg_ABC_Activity.this, Animated_Activity.class);
            startActivity(intent);
            Toast.makeText(this, "Animated Folder", Toast.LENGTH_LONG).show();
        }
        else
        {
            Intent intent = new Intent(Agg_ABC_Activity.this, Static_Page_Activity.class);
            startActivity(intent);
