...
import app.folder.example.dell.Speciality_March_Folder_2021.SwipeViewPager_Adapter.Speciality.Adapter_Spc_AC2
import java.util.*

class Spc_AC2_Activity : AppCompatActivity() {
    var viewPager: ViewPager? = null
    var adapter_spec_ac2: Adapter_Spc_AC2? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*toolbar close*/setContentView(R.layout.activity_spc_ac2)
...
*/
        ...
        adapter_spec_ac2 = Adapter_Spc_AC2(models as ArrayList<Model>, this)
        viewPager = findViewById(R.id.viewPager)
        viewPager?.setAdapter(adapter_spec_ac2)
        ...
        viewPager?.setOnPageChangeListener(object : OnPageChangeListener {
            override fun onPageScrolled(
                ...
                if (position < adapter_spec_ac2!!.count - 1 && position < colors!!.size - 1) {
