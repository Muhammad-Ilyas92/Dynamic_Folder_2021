...
import app.folder.example.dell.Speciality_March_Folder_2021.SwipeViewPager_Adapter.Speciality.Adapter_Spc_BC
import java.util.*

class Spc_BC_Activity : AppCompatActivity() {
    var viewPager: ViewPager? = null
    var adapterAgg_BC: Adapter_Spc_BC? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*toolbar close*/setContentView(R.layout.activity_spc_bc)
        ...
        findViewById(R.id.card_static).setOnClickListener(this);
*/
     ...
     //   cardView = (CardView) findViewById(R.id.cardview);
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // startActivity(new Intent(Admin_Activity.this,Static_Page_Activity.class));
...
*/models = ArrayList()
        models?.add(
            Model(
                R.drawable.qbal_title_folder,
                R.drawable.qbal_title_text_image,
                "  "
            )
        )


        adapterAgg_BC = Adapter_Spc_BC(models as ArrayList<Model>, this)
        viewPager = findViewById(R.id.viewPager)
        viewPager?.setAdapter(adapterAgg_BC)
        ...
        viewPager?.setOnPageChangeListener(object : OnPageChangeListener {
            override fun onPageScrolled(
                ...
                if (position < adapterAgg_BC!!.count - 1 && position < colors!!.size - 1) {
    ...
    public void onClick(View view) {
        if (R.id.card_animated != R.id.card_static) {
            Intent intent = new Intent(Agg_BC_Activity.this, Animated_Activity.class);
            startActivity(intent);
            Toast.makeText(this, "Animated Folder", Toast.LENGTH_LONG).show();
        }
        else
        {
            Intent intent = new Intent(Agg_BC_Activity.this, Static_Page_Activity.class);
            startActivity(intent);
