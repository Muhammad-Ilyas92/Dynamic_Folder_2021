...
import app.folder.example.dell.Speciality_March_Folder_2021.SwipeViewPager_Adapter.Speciality.Adapter_Spc_B
import java.util.*

class Spc_B_Activity : AppCompatActivity() {
    var viewPager: ViewPager? = null
    var adapterAgg_B: Adapter_Spc_B? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*toolbar close*/setContentView(R.layout.activity_spc_b)
...
*/models = ArrayList()
        ...
        adapterAgg_B = Adapter_Spc_B(models as ArrayList<Model>, this)
        viewPager = findViewById(R.id.viewPager)
        viewPager?.setAdapter(adapterAgg_B)
        ...
        viewPager?.setOnPageChangeListener(object : OnPageChangeListener {
            override fun onPageScrolled(
                ...
                if (position < adapterAgg_B!!.count - 1 && position < colors!!.size - 1) {
    ...
    public void onClick(View view) {
        if (R.id.card_animated != R.id.card_static) {
            Intent intent = new Intent(Agg_B_Activity.this, Animated_Activity.class);
            startActivity(intent);
            Toast.makeText(this, "Animated Folder", Toast.LENGTH_LONG).show();
        }
        else
        {
            Intent intent = new Intent(Agg_B_Activity.this, Static_Page_Activity.class);
            startActivity(intent);
