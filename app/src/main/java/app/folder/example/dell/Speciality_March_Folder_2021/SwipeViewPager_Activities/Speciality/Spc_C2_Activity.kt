...
import app.folder.example.dell.Speciality_March_Folder_2021.SwipeViewPager_Adapter.Speciality.Adapter_Spc_C2
import java.util.*

class Spc_C2_Activity : AppCompatActivity() {
    var viewPager: ViewPager? = null
    var adapter_spec_c2: Adapter_Spc_C2? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*toolbar close*/setContentView(R.layout.activity_spc_c2)
        ...
        adapter_spec_c2 = Adapter_Spc_C2(models as ArrayList<Model>, this)
        viewPager = findViewById(R.id.viewPager)
        viewPager?.setAdapter(adapter_spec_c2)
        viewPager?.setPadding(100, 0, 100, 0)
        val colors_temp = arrayOf(
            resources.getColor(R.color.color10),
            resources.getColor(R.color.color11),
            resources.getColor(R.color.color9) //      getResources().getColor(R.color.color12)
        )
        colors = colors_temp
        viewPager?.setOnPageChangeListener(object : OnPageChangeListener {
            override fun onPageScrolled(
                ...
                if (position < adapter_spec_c2!!.count - 1 && position < colors!!.size - 1) {
