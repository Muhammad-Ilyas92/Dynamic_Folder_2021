package app.folder.example.dell.Speciality_March_Folder_2021.SwipeViewPager_Activities
...
import app.folder.example.dell.Speciality_March_Folder_2021.SwipeViewPager_Adapter.Adapter_Static_Page
import java.util.*

class Static_Page_Activity : AppCompatActivity() {
    var adapterStaticPage: Adapter_Static_Page? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*toolbar close*/setContentView(R.layout.activity_static_page)
        ...
        models.add(new Model(R.drawable.flazol_title_folder, "Flazol", "The Ultimate Choice "));*/adapterStaticPage =
            Adapter_Static_Page(models as ArrayList<Model>, this)
        viewPager = findViewById(R.id.viewPager)
        viewPager?.setAdapter(adapterStaticPage)
        ...
        viewPager?.setOnPageChangeListener(object : OnPageChangeListener {
            override fun onPageScrolled(
                ...
                if (position < adapterStaticPage!!.count - 1 && position < colors!!.size - 1) {
