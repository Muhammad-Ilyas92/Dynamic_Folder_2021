...
import app.folder.example.dell.Speciality_March_Folder_2021.Activities_Static.*
...
class Adapter_Static_Page(private val models: List<Model>, private val context: Context) :
    PagerAdapter() {
